...
class EditProfileActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var nama = intent.getStringExtra("keyName")
        var telp = intent.getStringExtra("keyTelp")


        binding.apply {
            namaUser.setText(nama)
            nomorUser.setText(telp)
        }
